...
const createSortPointTemplate = (currentSortType) => (
  `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
    <div class="trip-sort__item  trip-sort__item--day">
      <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" 
      ${currentSortType === SortType.DAY ? 'checked' : ''} data-sort-type="${SortType.DAY}" name="trip-sort" value="sort-day" >
    ...
    <div class="trip-sort__item  trip-sort__item--time">
      ...
      ${currentSortType === SortType.TIME ? 'checked' : ''} data-sort-type="${SortType.TIME}" name="trip-sort" value="sort-time">
      <label class="trip-sort__btn" for="sort-time">Time</label>
    </div>

    <div class="trip-sort__item  trip-sort__item--price">
      <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" 
      ${currentSortType === SortType.PRICE ? 'checked' : ''} data-sort-type="${SortType.PRICE}" name="trip-sort" value="sort-price">
...
export default class SortPointView extends AbstractView {
  ...
  get template() {
    return createSortPointTemplate(this.#currentSortType);
  }
